<template>
  <div class="offcanvas offcanvas-end" style="max-width: 300px;" tabindex="-1" id="cart" aria-labelledby="shoppingCart" ref="offcanvasCart">
    ...
    <div class="offcanvas-body mb-5">
      <!-- 購物車無商品 -->
      <div v-if="carts.length === 0" class="d-flex justify-content-center align-items-center" style="min-height:600px">
        <p>購物車尚無商品</p>
      </div>
      <!-- 購物車有商品 -->
      <div v-else>
